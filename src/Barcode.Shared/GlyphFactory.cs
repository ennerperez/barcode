...
namespace Barcode
{
    ...
    public abstract class GlyphFactory
    {
        ...
        /// <see cref="T:Barcode.GlyphFactory"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="T:Barcode.BarGlyph"/> at the specified
        /// ordinal index.
        /// </summary>
        /// <param name="index">The glyph ordinal index.</param>
        /// <returns>
        /// A <see cref="T:Barcode.BarGlyph"/> glyph object.
        /// </returns>
        ...
        /// <summary>
        /// Gets the <see cref="T:Barcode.BarGlyph"/> that corresponds
        ...
        /// <summary>
        /// Gets the array of <see cref="T:Barcode.Glyph"/> objects that
        ...
        /// <summary>
        /// Gets the collection of <see cref="T:Barcode.BarGlyph"/> that
        ...
        /// <summary>
        /// Gets the collection of <see cref="T:Barcode.CompositeGlyph"/>
        /// that represent the composite bar-code glyphs for the given bar-code
        /// symbology.
        /// </summary>
        /// <returns>
        /// The full collection of <see cref="T:Barcode.CompositeGlyph"/>
